...
import { findWins } from './findWins';
import { findCards } from './findCards';

const YEAR = 2023;
const DAY = 4;

// solution path: /Users/hank/projects/advent-of-code-1/years/2023/04/index.ts
// data path    : /Users/hank/projects/advent-of-code-1/years/2023/04/data.txt
// problem url  : https://adventofcode.com/2023/day/4

async function p2023day4_part1(input: string, ...params: any[]) {
  return findWins(getRows(input));
}

async function p2023day4_part2(input: string, ...params: any[]) {
  return findCards(getRows(input));
}
