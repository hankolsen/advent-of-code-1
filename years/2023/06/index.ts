...
// solution path: /Users/hank/projects/advent-of-code-1/years/2023/06/index.ts
// data path    : /Users/hank/projects/advent-of-code-1/years/2023/06/data.txt
// problem url  : https://adventofcode.com/2023/day/6

async function p2023day6_part1(input: string, ...params: any[]) {
  return findBoatMoves(getRows(input));
}
